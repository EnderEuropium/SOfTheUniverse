...
起初的元素世界相当混乱，时间以相对基准世界/FW极快的速率进展着。可以肯定的是它诞生的短时间内就有了成型的<b>元素之力</b> 系统。SI联盟做出行动之时，EW的秩序已经由█████主导( 数个FW势力也想控制EW，但他们显然不是这个文明的对手 )。它对系统进行了一定的调整，并引入了<b>元素人</b> 。█████主要驻扎在Elearth主大陆外的一系列土地上。联盟最终成功驱逐█████、修复了EW时空。此时正值基准世界公元186█年█月█日。这之后，EW/FW/基准世界三者之间可以互相正常往来。
...
#### 元素之力与[IME](https://github.com/EnderEuropium/SOfTheUniverse/blob/master/SOTU_HomePage.md#%E4%BF%A1%E6%81%AF-%E7%89%A9%E8%B4%A8-%E8%83%BD%E9%87%8F%E4%BD%9C%E7%94%A8information-mass-energy-interaction%E4%B8%8E%E4%BF%A1%E6%81%AF-%E7%89%A9%E8%B4%A8-%E8%83%BD%E9%87%8F%E4%B8%89%E7%9B%B8%E7%BA%A0%E7%BC%A0%E7%90%86%E8%AE%BAime-triple-entangling-theory)
（事实上可以用不同的方式表征IME作用，此处为了方便，使用了不那么严谨的表述。）

概念是在分层组织的“槽”里封装的信息，而IME同样是关乎信息的作用。举例，氢元素的概念里封装了复数个特性（电子排布、单质密度等），由于概念抽取自FW和基准线世界，它还包含发现史、用途等要素。元素之力钯它配给EW的特定人和物，具体的转化存在随机性（以及█████的修改）。介于元素概念里本来就反映人类历史，且FW信息流内置（与基准线世界非常相似的）人类历史，加之EW能够“吸收”到基准线世界的人类历史，元素人发展“模仿”人类历史也不难理解了。整个转化可以认为是多条路径的叠加，借助ID值以形成一种循环。但是这个循环里存在█████设定的漏洞，相当于程序里有bug，越跑bug导致的错误积累越多。方法其一是烧ID值（有相应的仪式等等，打补丁），其二是尽量少用元素之力相关特性（减少循环转的次数），还有和FW的魔力之河相连。EW发展的过程对魔力之河影响很大，EW内部人则是感觉魔力之河渐渐改变了不再适合“保护”这个世界。大部分人不约而同地转向方法2，包括人造平凡晶。现在EW大部分地方都没法像以前那样表达元素之力带来的特殊能力。

最初的元素人像是摇篮里的婴儿被抛在元素世界，脑子里只有莫名的混乱的概念。他们在这片土地上建立起杂糅的世界。他们被告知自己是套了化学元素模板的晚期智人，继承了元素世界两边的平行宇宙的地球之概念史。然而元素世界的IME体系还未成形。随着他们的实践，模糊之物渐渐清晰，他们也终于“想起来了”自己是什么。这段时间被称为【神话时代】，H族的“三山”传说即来源于此。元素人的历史没有记载神话时代确切的长度，只知道当今的社会初具雏形。凭借着“恢复”的知识和手中的能力，元素人们开始大刀阔斧地改变世界，因而形成了后世所说的【飞跃时代】。总的来说，元素世界的发展快于基准线世界地球(同样也有原FW地球，和**我们**的现实世界的地球)文明，尽管中途屡次反复、左右横跳。结束【飞跃时代】的，是时空修复、世界大战和███入侵。 以上一部分来源█████的记录和SIA、FW等记录。
...
“元素地球”Elearth上存在数个通向基准世界地球或FW地球的传送门，其与联盟的超空间航道有相似之处。传送门亦可人工开启/关闭，元素人、SIA和███就曾经在EW的不同位置进行过这种操作。其中在Elearth上开启/关闭传送门最容易。介于基准世界\--FW传送门大部分早已出于种种原因成为历史，也会有人选择EW作为平行宇宙旅行的中转站。同时，三个世界的人类也会互相流动。元素人历史的早期曾经有FW生物来到EW定居，例如位于主大陆中部日暮森林的“双巨狼”。他们的活动区域往往也是魔法环境较为优良的区域。
...
098 Frieda(=弗丽达)|♀|某个SIA元素人家庭的孩子（之一？）。漂泊不定，后出于正义感等原因参与援助元素世界。与Thomas(095)在工作中认识，并成为cp。

105 Nadezhda(Надежда,=娜杰日达)|♀|诞生于罕见的自然形成的Db元素人家系。

106 Albert(=艾伯特)|♂|CGE **“航路计划( Project Seaway )”** 前几批诞生者。学生时代因为身份遭受了严重的校园霸凌，却也促使政策（主要是关于“人造元素”发展的）、社会风气的改变。目前为元素世界综合科学院高级研究员。和Thomas(095)、Frieda(098)是好友。
